...
getJSON('https://api.github.com/repos/TUMcps/AROC/commits?per_page=1',
    function(err, data) {
        if (err !== null) {
            ...
            container.innerHTML = `<object class="align-middle" data="https://img.shields.io/static/v1?label=Last update&message=${timeText} ago&color=4596FF" alt="TUMcps - AROC"></object>`;
