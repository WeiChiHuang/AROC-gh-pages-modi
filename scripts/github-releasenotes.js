...
getJSON('https://api.github.com/repos/TUMcps/AROC/commits?per_page=100',
    function(err, data) {
        if (err !== null) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                container.innerHTML +=
                   `<li id="AROCrelease_${i}" class="list-group-item px-0">
                    <a class="btn ${btnCollapsed}" data-bs-toggle="collapse" href="#collapse_AROCrelease_${i}" role="button"
                        aria-expanded="${isCollapsed}"
                        aria-controls="collapse_AROCrelease_${i}"
                        style="${stylestring}">
                        <div class="row">
                    ...
                    <div class="collapse ${collapseShow}" id="collapse_AROCrelease_${i}">
                    <div class="row">
                    <div class="col-12">
